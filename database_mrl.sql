...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2022 at 09:25 AM
...
--
CREATE DATABASE IF NOT EXISTS `database_mrl` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `database_mrl`;
...
('44361525', '713484', '20-02-2022', '20172516', 'Chưa xử lý'),
('49105134', '129278', '19-02-2022', '20172897', 'Chưa xử lý'),
('50698253', '129308', '19-02-2022', '20172516', 'Chưa xử lý'),
('56950219', '129288', '19-02-2022', '20172516', 'Chưa xử lý'),
('86851262', '129288', '19-02-2022', '20172897', 'Chưa xử lý'),
('96984679', '713484', '19-02-2022', '20172897', 'Chưa xử lý');
...
INSERT INTO `giaovu` (`email`, `password`, `name`) VALUES
('tung.vusong@hust.edu.vn', '123456', 'Vũ Song Tùng');
...
('20174226', 'Nguyễn Đình Dương', 'CKĐT-01', '123321', 'duong.nd174226@sis.hust.edu.vn');
...
('root', '[{\"db\":\"database_mrl\",\"table\":\"don_mrl\"},{\"db\":\"database_mrl\",\"table\":\"giaovu\"},{\"db\":\"database_mrl\",\"table\":\"hocphan\"},{\"db\":\"database_mrl\",\"table\":\"lop\"},{\"db\":\"database_mrl\",\"table\":\"sinhvien\"},{\"db\":\"database_mrl\",\"table\":\"thoihandki\"}]');
...
('root', '2022-02-20 08:25:45', '{\"Console\\/Mode\":\"collapse\"}');
